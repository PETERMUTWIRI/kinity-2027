...
export default function MobileActionBar() {
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      href: `https://twitter.com/intent/tweet?text=${encodeURIComponent('🇰🇪 Kenya\'s Hope 2027. Dr. Isaac Newton Kinity for President. Join the movement!')}&url=https://www.ukombozi.com`,
      color: 'bg-black',
    },
    {
      name: 'Facebook',
      ...
      href: `https://www.facebook.com/sharer/sharer.php?u=https://www.ukombozi.com`,
      color: 'bg-[#1877F2]',
    },
  ];
