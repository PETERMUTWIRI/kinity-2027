...
const endorsements = [
  {
    ...
    role: "Industry Body",
    quote: "The UKOMBOZI party's economic transformation plan addresses the real challenges facing Kenyan businesses.",
    logo: "KAM",
  },
  {
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Leaders and organizations across Kenya share their perspectives on the UKOMBOZI party&apos;s vision for our nation.
            </p>
          </div>
        </ScrollReveal>
