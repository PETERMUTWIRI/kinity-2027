...
export const metadata: Metadata = {
  title: 'Presidential Candidate | JENGAKENYA',
  description: 'Meet Dr. Isaac Newton Kinity, flagbearer of the JENGAKENYA, and discover the four pillars of his leadership: Integrity, Experience, Vision, and Commitment forged over 40+ years of sacrifice.',
  keywords: ['Isaac Newton Kinity', 'presidential candidate', 'Kenya', 'leadership', 'integrity', 'experience', 'vision', 'commitment'],
  openGraph: {
