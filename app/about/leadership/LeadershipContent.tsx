...
const leadershipValues = [
  {
    ...
    content: 'We do not seek power to rule; we seek responsibility to serve. Every official in the UKOMBOZI party is accountable to the people, not the other way around.',
  },
  {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal delay={0.2}>
            ...
            <p className="text-xl text-slate-600 leading-relaxed max-w-3xl mx-auto">
              The UKOMBOZI party is not a one-man show. It is a disciplined movement of servant-leaders 
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-6">
                    Presidential Candidate of the UKOMBOZI party. A veteran governance activist with over 
