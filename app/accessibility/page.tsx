...
export const metadata: Metadata = {
  title: 'Accessibility Statement | UKOMBOZI party',
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12">
            <div className="prose prose-lg max-w-none text-brand-text/80">
              ...
              <p className="text-xl text-brand-text/70 mb-8">
                UKOMBOZI party is committed to ensuring digital accessibility for people with 
              ...
              <p className="mb-4">
                ...
                to participate fully in the UKOMBOZI party.
              </p>
              ...
              <p className="mb-4">
                UKOMBOZI party strives to conform to <strong>WCAG 2.1 Level AA</strong> standards. 
