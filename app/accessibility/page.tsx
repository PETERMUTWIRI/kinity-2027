...
export const metadata: Metadata = {
  title: 'Accessibility Statement | JENGAKENYA',
  ...
  alternates: {
    canonical: 'https://www.jengakenya.com/accessibility',
  },
  robots: {
    index: true,
    follow: true,
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12">
            <div className="prose prose-lg max-w-none text-brand-text/80">
              ...
              <p className="text-xl text-brand-text/70 mb-8">
                JENGAKENYA is committed to ensuring digital accessibility for people with 
              ...
              <p className="mb-4">
                ...
                to participate fully in the JENGAKENYA.
              </p>
              ...
              <p className="mb-4">
                JENGAKENYA strives to conform to <strong>WCAG 2.1 Level AA</strong> standards. 
              ...
              <div className="bg-white rounded-xl p-6 mb-6 shadow-sm">
                <p className="mb-1"><strong>Email:</strong> <a href="mailto:info@jengakenya.com" className="text-brand-dark hover:underline">info@jengakenya.com</a></p>
                <p className="mb-1"><strong>General Contact:</strong> <a href="mailto:info@jengakenya.com" className="text-brand-dark hover:underline">info@jengakenya.com</a></p>
              </div>
