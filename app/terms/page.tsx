...
export const metadata: Metadata = {
  title: 'Terms of Service | Kikimo Foundation',
  description: 'Read the Terms of Service for using the Kikimo Foundation Campaign website. Guidelines for donations, event registrations, and volunteer participation.',
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12">
            <div className="prose prose-lg max-w-none text-brand-text/80">
              ...
              <p className="text-xl text-brand-text/70 mb-8">
                Welcome to Kikimo Foundation Campaign. By accessing or using our website, 
              ...
              <p className="mb-4">
                These Terms of Service govern your use of the Kikimo Foundation Campaign website and all 
              ...
              <p className="mb-4">
                Kikimo Foundation Campaign provides a platform for supporters to:
              </p>
              ...
              <p className="mb-4">
                When registering for events through Kikimo Foundation Campaign:
              </p>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <p className="mb-4">
                ...
                logos, campaign materials, and design elements, is the exclusive property of Kikimo Foundation Campaign or its 
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>You grant Kikimo Foundation Campaign a non-exclusive, royalty-free license to use, display, 
              ...
              <p className="mb-4">
                To the fullest extent permitted by law, Kikimo Foundation Campaign shall not be liable for any 
              ...
              <div className="bg-white rounded-xl p-6 mt-4 shadow-sm">
                <p className="mb-1"><strong>Kikimo Foundation Campaign</strong></p>
                <p className="mb-1">Email: <a href="mailto:contact@kikimofoundation.org" className="text-brand-dark hover:underline">contact@kikimofoundation.org</a></p>
                <p className="mb-1">General Inquiries: <a href="mailto:contact@kikimofoundation.org" className="text-brand-dark hover:underline">contact@kikimofoundation.org</a></p>
              </div>
