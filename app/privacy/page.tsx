...
export const metadata: Metadata = {
  title: 'Privacy Policy | Kikimo Foundation',
  description: 'Learn how the Kikimo Foundation Campaign collects, uses, and protects your personal information. Our commitment to your privacy and data security.',
  keywords: ['privacy policy', 'data protection', 'GDPR', 'personal information', 'cookies', 'political campaign'],
  alternates: {
    canonical: 'https://www.kikimofoundation.org/privacy',
  },
  robots: {
    index: true,
    follow: true,
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12">
            <div className="prose prose-lg max-w-none text-brand-text/80">
              ...
              <p className="text-xl text-brand-text/70 mb-8">
                The Kikimo Foundation Campaign is committed to protecting your privacy. This Privacy Policy explains 
              ...
              <p className="mb-4">
                To exercise these rights, please contact us at <a href="mailto:contact@kikimofoundation.org" className="text-brand-dark hover:underline">contact@kikimofoundation.org</a>.
              </p>
              ...
              <div className="bg-white rounded-xl p-6 mt-4 shadow-sm">
                ...
                <p>General Inquiries: <a href="mailto:contact@kikimofoundation.org" className="text-brand-dark hover:underline">contact@kikimofoundation.org</a></p>
              </div>
